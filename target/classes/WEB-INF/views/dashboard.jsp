...
<body>
	...
	<footer class="navbar-fixed-bottom">
		...
		<ul class="pagination">
			<li><a href="?pageElement=${pageSize}&pageNumber=${pageIndex-1}" aria-label="Previous" onclick=""> <span
					aria-hidden="true">&laquo;</span>
			</a></li>
			<li><a href="?pageElement=${pageSize}&pageNumber=1">1</a></li>
			<li><a href="?pageElement=${pageSize}&pageNumber=2">2</a></li>
			<li><a href="?pageElement=${pageSize}&pageNumber=3">3</a></li>
			<li><a href="?pageElement=${pageSize}&pageNumber=4">4</a></li>
			<li><a href="?pageElement=${pageSize}&pageNumber=5">5</a></li>
			<li><a href="?pageElement=${pageSize}&pageNumber=${pageIndex+1}" aria-label="Next" onclick=""> <span
